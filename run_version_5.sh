...
if [ -z $1 ]
  ...
  Rscript.exe "./r/version_5/dm01_resave_spss_as_qs_V5.R"
  pwd
fi

echo "Check and add country panel and wave variables"
Rscript.exe "./r/version_5/dm02_data_standardise_V5.R"

echo "Turn from wide data to long data.table"
Rscript.exe "./r/version_5/dm03_create_datatable_v5.R"

echo "Rename the variables"
Rscript.exe "./r/version_5/dm04_rename_vars_V5.R"

echo "Combine all countries and waves together"
Rscript.exe "./r/version_5/dm05_combine_data_V5.R"
...
Rscript.exe "./r/version_5/dm101_save_remote_V5.R"
