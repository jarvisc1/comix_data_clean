...
if [ -z $1 ]
  ...
  Rscript "r/version_6/dm01_resave_spss_as_qs_v6.R"
  pwd
fi
...
Rscript "r/version_6/dm02_data_standardise_v6.R"

echo "Turn from wide data to long data.table"
Rscript "r/version_6/dm03_create_datatable_v6.R"

echo "Rename the variables"
Rscript "r/version_6/dm04_rename_vars_v6.R"

echo "Combine all countries and waves together"
Rscript "r/version_6/dm05_combine_data_v6.R"
...
Rscript "r/version_6/dm100_save_locally_v6.R"

echo "Save data on LSHTM server"
Rscript "r/version_6/dm101_save_remote_v6.R"
