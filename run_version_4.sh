...
if [ -z $1 ]
  ...
  Rscript.exe "./r/version_4/dm01_resave_spss_as_qs_v4.R"
  pwd
fi

echo "Check and add country panel and wave variables"
Rscript.exe "r/version_4/dm02_data_standardise_v4.R"

echo "Turn from wide data to long data.table"
Rscript.exe "./r/version_4/dm03_create_datatable_v4.R"

echo "Rename the variables"
Rscript.exe "./r/version_4/dm04_rename_vars_v4.R"

echo "Combine all countries and waves together"
Rscript.exe "./r/version_4/dm05_combine_data_v4.R"
...
Rscript "./r/version_4/dm101_save_remote_v4.R"
