...
Rscript.exe ".\r\version_3\dm02_data_standardise_v3.R" $new_only

echo "Turn from wide data to long data.table"
Rscript.exe ".\r\version_3\dm03_create_datatable_v3.R" $new_only

echo "Rename the variables"
Rscript.exe ".\r\version_3\dm04_rename_vars_v3.R" $new_only

echo "Combine all countries and waves together"
Rscript.exe ".\r\version_3\dm05_combine_data_v3.R" $new_only

echo "Add adult survey variable"
Rscript.exe ".\r\version_3\dm06_swap_parent_child_info_v3.R" $new_only

echo "Add the multiple contacts as multiple rows"
Rscript.exe ".\r\version_3\dm07_allocate_multiple_contacts_v3.R" $new_only

echo "Clean data needs for contact analyses"
Rscript.exe ".\r\version_3\dm08_clean_contacts_v3.R" $new_only

echo "Clean location data"
Rscript.exe ".\r\version_3\dm09_clean_locations_v3.R" $new_only
...
Rscript.exe ".\r\version_3\dm101_save_remote_v3.R" $new_only
