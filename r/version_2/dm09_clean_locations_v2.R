## Name: dm09_clean_other_vars_v2.R
## Description: Clean variables not need for the contacts - less important for R.
## Input file: combined_8_v2.qs
## Functions:
## Output file: combined_9_v2.qs
...
input_name <-  paste0("combined_8_v2.qs")
output_name <- paste0("combined_9_v2.qs")
