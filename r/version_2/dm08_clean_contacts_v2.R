## Name: dm07_clean_contact_vars_v2.R
## Description: Clean the variables relating to the contact data.
## Input file: combined_7_v2.qs
## Functions:
## Output file: combined_8_v2.qs clean/contacts_v2.qs
...
input_name <-  paste0("combined_7_v2.qs")
input_data <-  file.path(dir_data_process, input_name)
output_name <- paste0("combined_8_v2.qs")
output_data <- file.path(dir_data_process, output_name)

## Save contact data
current_date <- Sys.Date()
output_cnts <- paste0("contacts_v2.qs")
