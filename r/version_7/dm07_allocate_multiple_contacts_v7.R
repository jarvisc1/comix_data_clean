...
## Input file: combined_6_v7.qs
## Functions:
## Output file: combined_7_v7.qs
...
input_name <-  paste0("combined_6_v7.qs")
output_name <- paste0("combined_7_v7.qs")
...
multi <- grep("multiple_contacts", names(dt), value =TRUE)
...
dt_prec <- dt_prec[
  !is.na(multiple_contacts_other_precautions) |
    ...
    !is.na(multiple_contacts_school_precautions) 
]
