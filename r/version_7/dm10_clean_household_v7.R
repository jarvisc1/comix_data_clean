## Name: dm09_clean_household_v7.R
## Description: Clean variables related to household members.
## Input file: combined_9_v7.qs
## Functions:
## Output file: combined_10_v7.qs, households_v7
...
input_name <-  paste0("combined_9_v7.qs")
input_data <-  file.path(dir_data_process, input_name)
output_name <- paste0("combined_10_v7.qs")
output_hhms <- paste0("households_v7.qs")
