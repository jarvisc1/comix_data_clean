## Name: dm09_clean_household_v9.R
## Description: Clean variables related to household members.
## Input file: combined_9_v9.qs
## Functions:
## Output file: combined_10_v9.qs, households_v9
...
input_name <-  paste0("combined_9_v9.qs")
input_data <-  file.path(dir_data_process, input_name)
output_name <- paste0("combined_10_v9.qs")
output_hhms <- paste0("households_v9.qs")
