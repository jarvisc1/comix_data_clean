## Name: dm09_clean_other_vars_v1.R
## Description: Clean variables not need for the contacts - less important for R.
## Input file: combined_8_v1.qs
## Functions:
## Output file: combined_9_v1.qs
...
input_name <-  paste0("combined_8_v1.qs")
output_name <- paste0("combined_9_v1.qs")
