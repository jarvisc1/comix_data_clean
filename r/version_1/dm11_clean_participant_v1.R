...
## Input file: combined_10_v1.qs
## Functions:
## Output file: combined_11_v1.qs, part_v1.qs, part_min_v1.qs
...
input_name <-  paste0("combined_10_v1.qs")
input_data <-  file.path(dir_data_process, input_name)
output_name <- paste0("combined_11_v1.qs")
output_data <- file.path(dir_data_process, output_name)

## Save participant data
current_date <- Sys.Date()
output_parts <- paste0("part_v1.qs")
output_parts_min <- paste0("part_min_v1.qs")
