...
## Input file: combined_5_v8.qs
## Functions:
## Output file: combined_6_v8.qs
...
if(latest == 1){
  input_name <-  paste0("combined_5_v8a.qs")
  output_name <- paste0("combined_6_v8a.qs")
} else if(latest ==0){
  input_name <-  paste0("combined_5_v8.qs")
  output_name <- paste0("combined_6_v8.qs")
}
