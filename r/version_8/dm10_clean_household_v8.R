## Name: dm09_clean_household_v8.R
## Description: Clean variables related to household members.
## Input file: combined_9_v8.qs
## Functions:
## Output file: combined_10_v8.qs, households_v8
...
if(latest == 1){
  input_name <-  paste0("combined_9_v8a.qs")
  output_name <- paste0("combined_10_v8a.qs")
  output_hhms <- paste0("households_v8a.qs")
} else if(latest ==0){
  input_name <-  paste0("combined_9_v8.qs")
  output_name <- paste0("combined_10_v8.qs")
  output_hhms <- paste0("households_v8.qs")
}
