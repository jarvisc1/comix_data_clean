## Name: dm09_clean_other_vars_v8.R
## Description: Clean variables not need for the contacts - less important for R.
## Input file: combined_8_v8.qs
## Functions:
## Output file: combined_9_v8.qs
...
if(latest == 1){
  input_name <-  paste0("combined_8_v8a.qs")
  output_name <- paste0("combined_9_v8a.qs")
} else if(latest ==0){
  input_name <-  paste0("combined_8_v8.qs")
  output_name <- paste0("combined_9_v8.qs")
}
