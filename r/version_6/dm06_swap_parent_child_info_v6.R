...
## Input file: combined_5_v6.qs
## Functions:
## Output file: combined_6_v6.qs
...
input_name <-  paste0("combined_5_v6.qs")
output_name <- paste0("combined_6_v6.qs")
...
hhm_cols <- c("hhm_gender","hhm_gender", "hhm_age_group", "hhm_elevated_risk")
